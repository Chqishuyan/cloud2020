...
import com.atguigu.springcloud.fallback.PaymentFallbackFactory;
...
@Component
@FeignClient(name = "cloud-payment-service",/*fallback = PaymentFallbackService.class*/ fallbackFactory = PaymentFallbackFactory.class)
